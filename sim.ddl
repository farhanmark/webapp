...
DROP TABLE Project_ship CASCADE CONSTRAINTS ;
...
CREATE TABLE Project_ship
  (
    project_ship_id        INTEGER NOT NULL ,
    SIM_Person_person_id   INTEGER ,
    SIM_project_project_id INTEGER
  ) ;
ALTER TABLE Project_ship ADD CONSTRAINT Project_ship_PK PRIMARY KEY ( project_ship_id ) ;
...
ALTER TABLE Project_ship ADD CONSTRAINT Project_ship_SIM_Person_FK FOREIGN KEY ( SIM_Person_person_id ) REFERENCES SIM_Person ( person_id ) ;

ALTER TABLE Project_ship ADD CONSTRAINT Project_ship_SIM_project_FK FOREIGN KEY ( SIM_project_project_id ) REFERENCES SIM_project ( project_id ) ;
